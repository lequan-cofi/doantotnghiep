...
function initNavigation() {
    ...
    navItems.forEach(item => {
        item.addEventListener('click', function(e) {
            ...
            // If item has href, let browser navigate naturally (no preventDefault)
        });
    });
}
...
function initChart() {
    ...
    if (canvas) {
        // Revenue chart for manager dashboard
        const monthlyData = {
            labels: ['Tháng 7', 'Tháng 8', 'Tháng 9', 'Tháng 10', 'Tháng 11', 'Tháng 12'],
            revenue: [25.5, 28.2, 31.5, 29.8, 35.2, 38.5],
            commission: [2.5, 2.8, 3.2, 3.0, 3.5, 3.9]
        };
        const ctx = canvas.getContext('2d');
        
        // Create Chart.js revenue chart
        new Chart(ctx, {
            type: 'line',
            data: {
                ...
                datasets: [
                    ...
                    {
                        label: 'Hoa hồng (triệu VNĐ)',
                        data: monthlyData.commission,
                        borderColor: '#10b981',
