...
<link rel="stylesheet" href="{{ asset('assets/css/agent/rooms-create.css') }}?v={{ time() }}">
@endpush

@push('scripts')
<script src="{{ asset('assets/js/agent/rooms.js') }}?v={{ time() }}"></script>
<script src="{{ asset('assets/js/agent/rooms-create.js') }}?v={{ time() }}"></script>
@endpush
            ...
            <div class="row align-items-center">
                <div class="col-md-8">
                    <div class="d-flex align-items-center">
                        <a href="{{ route('agent.rooms.index') }}" class="btn btn-outline-secondary me-3">
                        ...
                        <div>
                            <h1 class="h3 mb-1 fw-bold text-dark">Thêm phòng mới</h1>
                            <p class="text-muted mb-0">Tạo phòng trọ mới trong hệ thống</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 text-end">
                    <div class="btn-group" role="group">
                        ...
                        <button class="btn btn-success" onclick="saveRoom()">
                            <i class="fas fa-save me-2"></i>
                            Lưu phòng
                        </button>
                    </div>
                        ...
                        <div class="card-body">
                            <div class="row g-3">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="roomTitle" name="title" required>
                        ...
                        <div class="card-body">
                            <div class="image-upload-area" id="imageUploadArea">
                                <div class="upload-placeholder">
                                    ...
                                    <p class="mb-2">Kéo thả hình ảnh vào đây hoặc click để chọn</p>
                    ...
                    <div class="card shadow-sm mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" id="roomFeatured" name="featured">
                    ...
                    <div class="card shadow-sm">
                        ...
                        <div class="card-body">
                            <div class="d-grid gap-2">
                                ...
                                <button type="button" class="btn btn-outline-info" onclick="duplicateFromTemplate()">
...
<div class="modal fade" id="templateModal" tabindex="-1">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Chọn mẫu phòng</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
            </div>
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-6 mb-3">
                        <div class="card template-card" onclick="selectTemplate('basic')">
                            <div class="card-body text-center">
                                <i class="fas fa-home fs-1 text-primary mb-3"></i>
                                <h6>Phòng cơ bản</h6>
                                <small class="text-muted">Phòng trọ đơn giản với tiện ích cơ bản</small>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 mb-3">
                        <div class="card template-card" onclick="selectTemplate('premium')">
                            <div class="card-body text-center">
                                <i class="fas fa-crown fs-1 text-warning mb-3"></i>
                                <h6>Phòng cao cấp</h6>
                                <small class="text-muted">Phòng trọ đầy đủ tiện ích hiện đại</small>
                            </div>
                        </div>
                    </div>
                </div>
