...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <div class="d-flex gap-2">
            <a href="{{ route('agent.tickets.edit', $ticket->id) }}" class="btn btn-warning">
                ...
                <div class="card-body">
                    ...
                    @if($ticket->lease)
                        ...
                        <p class="mb-3">
                            ...
                            Khách thuê: {{ $ticket->lease->tenant->full_name ?? 'Chưa có khách thuê' }}<br>
                            <small class="text-muted">
...
document.getElementById('addLogForm').addEventListener('submit', function(e) {
    ...
    fetch(`/agent/tickets/{{ $ticket->id }}/logs`, {
        method: 'POST',
        body: formData,
        headers: {
