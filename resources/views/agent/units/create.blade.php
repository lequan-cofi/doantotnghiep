    ...
    <header class="header">
        <div class="header-content">
            <div class="header-info">
                ...
                <p>Tạo phòng trọ mới trong bất động sản được gán quản lý</p>
            </div>
            ...
            <div class="col-lg-8">
                <div class="card shadow-sm">
                    <div class="card-header bg-primary text-white">
                        <h5 class="mb-0"><i class="fas fa-plus"></i> Thông tin phòng mới</h5>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('agent.units.store') }}" method="POST">
                            @csrf
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" name="code" id="code" class="form-control @error('code') is-invalid @enderror" 
                                           value="{{ old('code') }}" placeholder="VD: P101, A201" required>
                                    @error('code')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input type="number" name="floor" id="floor" class="form-control @error('floor') is-invalid @enderror" 
                                           value="{{ old('floor') }}" placeholder="VD: 1, 2, 3" min="1" max="100">
                                    @error('floor')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input type="number" name="area_m2" id="area_m2" class="form-control @error('area_m2') is-invalid @enderror" 
                                           value="{{ old('area_m2') }}" placeholder="VD: 25.5" step="0.01" min="0" max="1000">
                                    @error('area_m2')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <select name="unit_type" id="unit_type" class="form-select @error('unit_type') is-invalid @enderror" required>
                                        ...
                                        <option value="room" {{ old('unit_type') == 'room' ? 'selected' : '' }}>Phòng trọ</option>
                                        ...
                                        <option value="shared" {{ old('unit_type') == 'shared' ? 'selected' : '' }}>Phòng chung</option>
                                    </select>
                                    @error('unit_type')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="number" name="base_rent" id="base_rent" class="form-control @error('base_rent') is-invalid @enderror" 
                                           value="{{ old('base_rent') }}" placeholder="VD: 2500000" min="0" required>
                                    @error('base_rent')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="number" name="deposit_amount" id="deposit_amount" class="form-control @error('deposit_amount') is-invalid @enderror" 
                                           value="{{ old('deposit_amount') }}" placeholder="VD: 2500000" min="0">
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="number" name="max_occupancy" id="max_occupancy" class="form-control @error('max_occupancy') is-invalid @enderror" 
                                           value="{{ old('max_occupancy', 1) }}" placeholder="VD: 2" min="1" max="10" required>
                                    @error('max_occupancy')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea name="note" id="note" class="form-control @error('note') is-invalid @enderror" 
                                          rows="3" placeholder="Ghi chú về phòng (tùy chọn)">{{ old('note') }}</textarea>
                                @error('note')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="d-flex justify-content-end gap-2">
                                <a href="{{ route('agent.units.index') }}" class="btn btn-secondary">
