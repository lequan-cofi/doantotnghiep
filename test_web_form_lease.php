...
echo "Testing web form lease creation...\n";
...
// Create a mock request with web form data
$request = new Request();
$request->merge([
    'unit_id' => $unit->id,
    'tenant_id' => 1,
    ...
    'rent_amount' => '15.000.000', // Formatted currency
    'deposit_amount' => '3.000.000', // Formatted currency
    'billing_day' => 1,
    'status' => 'active',
    'signed_at' => now()->format('Y-m-d'),
    'contract_no' => 'TEST-WEB-' . time(),
]);
