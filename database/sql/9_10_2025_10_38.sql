...
CREATE TABLE `geo_provinces_2025` (
  ...
  `name` varchar(150) COLLATE utf8mb4_unicode_ci NOT NULL,
  `name_local` varchar(150) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `kind` enum('province','city','municipality') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'province',
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`code`),
...
CREATE TABLE `geo_wards_2025` (
  ...
  `name` varchar(150) COLLATE utf8mb4_unicode_ci NOT NULL,
  `name_local` varchar(150) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `kind` enum('ward','commune','townlet') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'ward',
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`code`),
...
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Địa chỉ theo chuẩn geo codes';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `locations_2025` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `country_code` varchar(10) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'VN',
  `province_code` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `ward_code` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `street` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `country` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Tòa nhà/Tài sản';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `sessions` VALUES ('YRNbaloLMo8GpqBm2xZ34AaDWESYoUCrh4LaTOv7',4,'127.0.0.1','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/141.0.0.0 Safari/537.36 Edg/141.0.0.0','',1760024307);
...
-- Dump completed on 2025-10-09 22:39:06
