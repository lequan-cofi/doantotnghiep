...
CREATE TABLE `geo_wards_2025` (
  ...
  CONSTRAINT `geo_wards_2025_district_code_foreign` FOREIGN KEY (`district_code`) REFERENCES `geo_districts` (`code`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `sessions` VALUES ('YRNbaloLMo8GpqBm2xZ34AaDWESYoUCrh4LaTOv7',4,'127.0.0.1','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/141.0.0.0 Safari/537.36 Edg/141.0.0.0','',1760020007);
...
-- Dump completed on 2025-10-09 22:15:36
