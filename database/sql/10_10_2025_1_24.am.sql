...
CREATE TABLE `geo_wards_2025` (
  ...
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`code`),
  KEY `geo_wards_2025_district_code_index` (`province_code`),
  CONSTRAINT `geo_wards_2025_province_code_foreign` FOREIGN KEY (`province_code`) REFERENCES `geo_provinces_2025` (`code`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `payroll_cycles` (
  ...
  `organization_id` bigint unsigned NOT NULL,
  `period_month` char(7) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'YYYY-MM',
  `status` enum('open','locked','paid') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'open',
...
CREATE TABLE `payroll_items` (
  ...
  `user_id` bigint unsigned NOT NULL,
  `item_type` enum('base','allowance','overtime','commission','bonus','deduction','insurance','tax','advance','other') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
INSERT INTO `properties` VALUES (1,NULL,6,7,'Bất động sản Hà Hà',1,NULL,'Bất động sản',6,24,1,'2025-10-09 01:59:52','2025-10-09 11:14:31','2025-10-09 11:14:31',4),(2,NULL,6,2,'Bất động sản Ba Ba',2,NULL,'sđfs',6,0,1,'2025-10-09 09:13:50','2025-10-09 09:30:21','2025-10-09 09:10:10',NULL),(3,NULL,6,1,'Bất động sản La La',3,NULL,'adsas',6,30,0,'2025-10-09 09:24:55','2025-10-09 09:25:18','2025-10-09 09:25:18',NULL),(4,NULL,6,1,'Bất động sản La',4,NULL,'dfgv',6,500,1,'2025-10-09 09:33:26','2025-10-09 09:34:18','2025-10-09 09:34:18',4),(5,NULL,6,6,'Bất động sản La',5,NULL,'è',6,100,1,'2025-10-09 11:15:12','2025-10-09 11:34:59',NULL,NULL),(6,NULL,6,NULL,'Bất động sản Ba Ka',6,5,'zXz',6,4,1,'2025-10-09 15:29:09','2025-10-09 15:29:09',NULL,NULL),(7,NULL,6,6,'Bất động sản Ba K',7,6,'gchbhcg',6,50,1,'2025-10-09 18:10:21','2025-10-09 18:10:21',NULL,NULL),(8,1,6,6,'Nhà trọ ABC',2,NULL,'Nhà trọ sạch sẽ, gần trường học',4,20,1,'2025-10-09 18:18:24','2025-10-09 18:18:24',NULL,NULL),(9,1,6,7,'Chung cư mini XYZ',3,NULL,'Chung cư mini hiện đại',6,30,1,'2025-10-09 18:18:24','2025-10-09 18:18:24',NULL,NULL);
...
CREATE TABLE `salary_advances` (
  ...
  `user_id` bigint unsigned NOT NULL,
  `amount` decimal(12,2) NOT NULL,
  `status` enum('requested','approved','deducting','settled','rejected') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'requested',
...
CREATE TABLE `salary_contracts` (
  ...
  `currency` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'VND',
  `pay_cycle` enum('monthly') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'monthly',
  ...
  `status` enum('active','ended','on_hold') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'active',
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `deleted_at` timestamp NULL DEFAULT NULL,
  `deleted_by` bigint unsigned DEFAULT NULL,
...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Cấu hình lương & phụ cấp';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `salary_contracts` VALUES (1,1,5,0.00,'VND','monthly',5,NULL,NULL,'2025-10-10',NULL,'active','2025-10-09 18:20:30','2025-10-09 18:20:30',NULL,NULL);
...
INSERT INTO `sessions` VALUES ('Y0mCSPRgYhakmqQuxy8Pbfh3af8RAv6VvYKmbfEK',4,'127.0.0.1','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/141.0.0.0 Safari/537.36 Edg/141.0.0.0','',1760034031);
...
-- Dump completed on 2025-10-10  1:25:04
